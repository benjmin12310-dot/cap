...
.pwa-banner-inner {
    max-width: 520px;
    margin: 0 auto;
    background: var(--blue-900, #071d40);
...
#pwa-update-toast {
    position: fixed;
    top: 16px; left: 50%; transform: translateX(-50%) translateY(-80px);
    background: #1e40af;
    color: #fff;
    padding: 10px 18px;
    border-radius: 12px;
